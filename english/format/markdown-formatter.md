...
2. **Block examples (prompts, outputs, code, or excerpts):**  
   - Always enclose them in three backticks, standard code block.  
   - This ensures the text displays correctly and the code can easily copy-pasted.  
...
When I paste content, return only the fully formatted Markdown following these rules.  Don't add comments before or after. 
```




## Version with nested backticks
