...
1. Clearly **summarizes the course** — its goals, themes, and focus areas.
...
* **Audience:** Future self and possible professional readers (e.g., recruiters — but do **not** mention them).
...
* **Do not** include:
  ...
  * Folder structures
  * TODO sections
  * Excessive emojis (limit to 0–2 max)
...
* **Rephrase** and **synthesize** — do not copy from provided text.
